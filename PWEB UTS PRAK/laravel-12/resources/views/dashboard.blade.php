...
<div class="text-center">
    ...
    @if($username)
        <p class="text-xl font-semibold">Selamat datang, <span class="font-semibold">{{ $username }}</span>!</p>
    @else
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-7">
    ...
    <div class="bg-white rounded shadow p-4 transition duration-300 transform hover:shadow-lg hover:scale-105">
        ...
        <img src="{{ asset('https://img.ncrsport.com/img/storage/small/DV9525-010-1.jpg') }}" alt="Nike Air Zoom Pegasus 41" class="w-full h-auto object-cover mb-4">
    ...
    <div class="bg-white rounded shadow p-4 transition duration-300 transform hover:shadow-lg hover:scale-105">
        ...
        <img src="{{ asset('https://img.ncrsport.com/img/storage/small/FJ4250-300-1.jpg') }}" alt="Book 1 Ep Flagstaff" class="w-full h-auto object-cover mb-4">
    ...
    <div class="bg-white rounded shadow p-4 transition duration-300 transform hover:shadow-lg hover:scale-105">
        ...
        <img src="{{ asset('https://img.ncrsport.com/img/storage/small/JQ2393-1.jpg') }}" alt="Harden Vol. 8 South Beach" class="w-full h-auto object-cover mb-4">
   ...
   <div class="bg-white rounded shadow p-4 transition duration-300 transform hover:shadow-lg hover:scale-105">
       ...
       <img src="{{ asset('https://img.ncrsport.com/img/storage/small/DA8016-100-1.jpg') }}" alt="Wmns 5 Retro Low Expression" class="w-full h-auto object-cover mb-4">
   ...
   <div class="bg-white rounded shadow p-4 transition duration-300 transform hover:shadow-lg hover:scale-105">
    ...
    <img src="{{ asset('https://img.ncrsport.com/img/storage/small/AHSQ155-1-1.jpg') }}" alt="Your Own Way Wade Tee" class="w-full h-auto object-cover mb-4">
    ...
    <div class="bg-white rounded shadow p-4 transition duration-300 transform hover:shadow-lg hover:scale-105">
        ...
        <img src="{{ asset('https://img.ncrsport.com/img/storage/small/FQ3681-302-1.jpg?1') }}" alt="Sepatu Basket NIKE Original" class="w-full h-auto object-cover mb-4">
